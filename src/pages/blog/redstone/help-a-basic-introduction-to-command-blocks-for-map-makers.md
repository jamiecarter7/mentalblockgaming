...
There are lots of dataTags to play around with, and [Gamepedia’s(http://minecraft.gamepedia.com/Tutorials/Command_NBT_Tags)] comprehensive table shows you how to use each one.
